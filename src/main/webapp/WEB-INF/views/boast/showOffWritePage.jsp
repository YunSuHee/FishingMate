...
<!-- 헤더 끝 -->
<form action="${pageContext.request.contextPath }/boast/writeshowOffProcess.do" method="post" enctype="multipart/form-data">
	...
	<div class="col-10">
		...
		<div class="row mt-3">
			...
			<div class="col-2 mt-1" id="box2">
				<input type="text" style="width:170px;" name="showoff_freeboard_fishlength" class="form-control" placeholder="길이를 입력하세요!">
			</div>
		...
		<div class="row">
			...
			<div class="col-4 mt-1 text-center" id="box3">
				<input id="input_showoff_title" name="showoff_freeboard_title" type="text" style="width:400px;" class="form-control" placeholder="제목을 입력하세요!">
			</div>
		...
		<div class="row mt-3">
			...
			<div class="col">
				<textarea class="form-control h-100" name="showoff_freeboard_content" cols="50" rows="10"></textarea>
			</div>
			<div class="col">
			</div>
		</div>
