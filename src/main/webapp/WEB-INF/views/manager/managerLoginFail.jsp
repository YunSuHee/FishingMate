   ...
   <!-- 헤더 끝 -->
      <div class="row">
         ...
         <div id="divmt"class="col" style="text-align:center;">
               <h3><img src="/fishingmate/resources/img/clear_mh.png" width="70" height="70"><br>
               아이디 및 비밀번호가 <strong>틀렸습니다</strong></h3>
               다시한번 확인 해주세요.<br>
            <div id="divmb"class="row border-top border-1 mt-3">
               ...
               <div class="col border border-1 mt-5 mb-5" style="height:100px; background-color:#424242">
                  <br>
                  <a href="${pageContext.request.contextPath }/manager/managerLoginPage.do"><img src="/fishingmate/resources/img/enter_mh2.png" width="40" height="40"><br>
