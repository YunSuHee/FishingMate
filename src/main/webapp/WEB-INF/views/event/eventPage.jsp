         ...
         <div class="col-10">
            <div class="row mt-3">
               ...
               <div class="col" align="center">
                  <span id="festival"><img src="${pageContext.request.contextPath }/resources/img/fishing_loving_everyday.png" width="70" height="70">Fishing Festival_</span>
                  <hr>
               </div>
            </div>
                  ...
                  <c:forEach items="${freeboardList}" var="list">
                     <c:if test="${list.eventVO.event_freeboard_approve != 'N'}">
                        <div class="col-3 card mt-3 me-1 ms-1 p-0" style="width: 26%;">
                           <a href="${pageContext.request.contextPath }/event/readNewsPage.do?event_freeboard_no=${list.eventVO.event_freeboard_no}">
            ...
            <!-- 페이징 버튼 -->
            <div class="row mt-3">
               <hr style="width: 896px; margin-left: 90px;">
               <div class="col-4"></div>
               <div class="col" style="align-items: center;" id="eventpgnation">
                  <ul style="text-align: center;"
                     class="pagination justify-content-center">
                     <li
                        style="margin-left: 0px; margin-right: 0px; text-align: center;"
                        class="page-item disabled mx-0"><a class="page-link"
                        href="#" tabindex="-1" aria-disabled="true">Prev</a></li>
                     <li
                        style="margin-left: 0px; margin-right: 0px; text-align: center;"
                        class="page-item active mx-0"><a class="page-link" href="#">1</a></li>
                     <li
                        style="margin-left: 0px; margin-right: 0px; text-align: center;"
                        class="page-item mx-0" aria-current="page"><a
                        class="page-link" href="#">2</a></li>
                     <li
                        style="margin-left: 0px; margin-right: 0px; text-align: center;"
                        class="page-item mx-0"><a class="page-link" href="#">3</a></li>
                     <li
                        style="margin-left: 0px; margin-right: 0px; text-align: center;"
                        class="page-item mx-0"><a class="page-link" href="#">Next</a>
                     </li>
                  </ul>
               </div>
               <div class="col-4" align="right">
                  <c:choose>
                     <c:when test="${!empty sessionUser }">
                        <a href="${pageContext.request.contextPath }/event/eventWritePage.do"><button type="button" class="btn btn-outline-light" style="color: white; float:right; background: #000080">글 작성 <i class="bi bi-pencil-square"></i></button></a>
                     </c:when>
                     <c:otherwise>
                        <a href="${pageContext.request.contextPath }/member/loginPage.do"><button type="button" class="btn btn-outline-light" style="color: white; float:right; background: #000080">글 작성 <i class="bi bi-pencil-square"></i></button></a>
                     </c:otherwise>
                  </c:choose>
               </div>
            </div>
