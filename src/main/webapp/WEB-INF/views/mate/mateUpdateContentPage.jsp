...
<script type="text/javascript">
	...
	var region_category_no = ${oneMateContent.mateFreeboardVO.region_category_no};
	var chkFirst = 0;
		...
		xmlhttp.onreadystatechange = function(){
			if(xmlhttp.readyState==4 && xmlhttp.status == 200){
				...
				for(var regionList of obj.regionListVO){
					...
					if (chkFirst == 0) {
						if (regionList.region_category_no == region_category_no) {
...
<body onload="getRegionCategoryList()">
			...
			<div class="row">
				...
				<div class="col-10">
					<div class="row my-4">
						<div class="col-1"></div>
						<div class="col">
							<span class="fs-2 fw-bold">메이트 글수정</span>
						</div>
					</div>
					<div class="row">
						<div class="col-1"></div>
						<div class="col">
							<form id="mate_freeboard_frm" action="${pageContext.request.contextPath }/mate/mateUpdateContentProcess.do" method="post">
								<!-- 제목 입력 -->
								<div class="row mb-3">
									<div class="col-2"></div>
									<div class="col form-floating">
										<input type="text" name="mate_freeboard_title" class="form-control" id="floatingInput" value="${oneMateContent.mateFreeboardVO.mate_freeboard_title }">
									...
									<div class="col-2 d-grid">
										<select class="form-select" id="select_fishing_category" name="fishing_category_no" onchange="getRegionCategoryList()" aria-label="Default select example">
											...
											<c:forEach items="${commonCategoryList.fishingCategoryList }" var="fishingCategory">
												<option value="${fishingCategory.fishing_category_no }" 
													<c:if test="${oneMateContent.fishingCategoryVO.fishing_category_no == fishingCategory.fishing_category_no }">selected</c:if>>
													${fishingCategory.fishing_category_name }
												</option>
											</c:forEach>
										</select>
									</div>
									...
									<div class="col-2 d-grid">
										<select class="form-select" id="mate_freeboard_maxnumber" name="mate_freeboard_maxnumber" aria-label="Default select example">
											...
											<c:forEach begin="1" end="4" var="num">
												<option value="${num }" <c:if test="${oneMateContent.mateFreeboardVO.mate_freeboard_maxnumber == num }">selected</c:if>>
													${num }명
												</option>
											</c:forEach>
										</select>
								...
								<div class="row mb-2">
									...
									<div class="col-3">
										<input type="text" id="mate_freeboard_fishingholename" class="form-control" name="mate_freeboard_fishingholename" value="${oneMateContent.mateFreeboardVO.mate_freeboard_fishingholename }">
									</div>
									<div class="col"></div>
								</div>
								<!-- 낚시터 주소 입력 -->
								<div class="row mb-2">
									...
									<div class="col-3">
										<input type="text" class="form-control"  name="mate_freeboard_postcode" id="sample4_postcode" name="mate_freeboard_postcode" placeholder="우편번호" value="${oneMateContent.mateFreeboardVO.mate_freeboard_postcode }">
									</div>
									<div class="col-2">
								...
								<div class="row mb-2">
									<div class="col-2"></div>
									<div class="col-2">
										<input type="text" class="form-control" name="mate_freeboard_roadAddress" id="sample4_roadAddress" placeholder="도로명주소" value="${oneMateContent.mateFreeboardVO.mate_freeboard_roadAddress }">
									</div>
									<div class="col-2">
										<input type="text" class="form-control" name="mate_freeboard_jibunAddress" id="sample4_jibunAddress" placeholder="지번주소" value="${oneMateContent.mateFreeboardVO.mate_freeboard_jibunAddress }">
										<span id="guide" style="color:#999;display:none"></span>
									</div>
									<div class="col-2">
										<input type="text" class="form-control" name="mate_freeboard_detailAddress" id="sample4_detailAddress" placeholder="상세주소" value="${oneMateContent.mateFreeboardVO.mate_freeboard_detailAddress }">
									</div>
									<div class="col-2">
										<input type="text" class="form-control" name="mate_freeboard_extraAddress" id="sample4_extraAddress" placeholder="참고항목" value="${oneMateContent.mateFreeboardVO.mate_freeboard_extraAddress }">
									</div>
								</div>
								<div class="row mb-2">
									<div class="col-2 text-center">
									...
									<div class="col-3">
										<input type="date" class="form-control" id="mate_freeboard_startdate" name="mate_freeboard_startdate" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${oneMateContent.mateFreeboardVO.mate_freeboard_startdate }"/>">
									</div>
									...
									<div class="col-3">
										...
										<input type="date" class="form-control" id="mate_freeboard_enddate" name="mate_freeboard_enddate" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${oneMateContent.mateFreeboardVO.mate_freeboard_enddate }"/>">
									</div>
								</div>
								<div class="row mb-2">
									<div class="col-2"></div>
									<div class="col form-floating"">
										<textarea class="form-control" name="mate_freeboard_content" id="floatingTextarea2" style="height: 200px; resize: none;">${oneMateContent.mateFreeboardVO.mate_freeboard_content }</textarea>
								...
								<div class="row">
									...
									<div class="col d-grid">
										<button onclick="return mateWriteContentProcess()" class="btn btn-primary">수정</button>
									</div>
									<div class="col d-grid">
